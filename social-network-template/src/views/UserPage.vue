...
export default {
    ...
    methods: {
        ...
        // Метод для вывода относительного времени публикации поста.
    ...
    <div class="user-page">
        ...
        <div class="user-container" v-if="isReady">
            ...
            <div class="user-wall">
                ...
                <form v-if="$route.name == 'profile'" class="post-form my-3" @submit.prevent="createPost">
                ...
                <!-- Посты -->
                <div class="user-post card mb-3" v-for="(item, index) in posts" :key="item._id || index">
                    <div class="card-body">
